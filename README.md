...
For the **voice-agent** project you also bring your **own** OpenAI and ElevenLabs keys
(both have free/trial tiers). The **slack-quote** project needs no paid keys — just a
