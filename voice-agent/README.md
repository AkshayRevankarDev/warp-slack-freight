...
For this round: the **Warp API is the local mock** (no Warp key needed), and you bring
your **own OpenAI and ElevenLabs keys** — both have free/trial tiers. Keep every key
server-side.
...
Because the OpenAI and ElevenLabs APIs change often, work from their current official
